...
SMODS.Tag({
    ...
    loc_vars = function(self, info_queue, card)
        ...
        info_queue[#info_queue + 1] = G.P_CENTERS['p_ortalab_mid_loteria_1']
    ...
    apply = function(tag, context)
        tag:yep('+', G.C.GREEN,function()
            for i=1, tag.config.packs do
                ...
                G.shop_booster.T.y, G.CARD_W*1.27, G.CARD_H*1.27, G.P_CARDS.empty, G.P_CENTERS['p_ortalab_mid_loteria_'..i], {bypass_discovery_center = true, bypass_discovery_ui = true})
